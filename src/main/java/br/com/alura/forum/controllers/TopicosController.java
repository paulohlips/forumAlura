...
import br.com.alura.forum.controllers.dto.AtualizacaoTopicoForm;
import br.com.alura.forum.controllers.dto.DetalheTopicoDto;
import br.com.alura.forum.controllers.dto.TopicoDto;
import br.com.alura.forum.controllers.form.TopicoFormDto;
...
public class TopicosController {
    ...
    public  ResponseEntity<DetalheTopicoDto> detalhar(@PathVariable Long id){
        ...
        if(optional.isPresent()){
            //topico está dentro de optional
    ...
    public ResponseEntity<TopicoDto> atualizar(@PathVariable Long id, @RequestBody @Valid AtualizacaoTopicoForm form){
        //JPA percebe atualização e commita (@Transaction) no final do método, por isso não tem um método update no repository
        Optional<Topico> optional = topicoRepository.findById(id);
        if(optional.isPresent()){
